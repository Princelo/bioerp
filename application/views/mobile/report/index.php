...
<body>
	...
	<header class="wy-header">
		...
		<div class="wy-header-titlenew" style="">报表查询系统</div>
	</header>
			...
			<div class="weui-cells weui-cells_form wy-address-edit">
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label wy-lab">查询类型</label>
					</div>
				...
				<div class="weui-cell select-month">
					<div class="weui-cell__hd">
						<label class="weui-label wy-lab">起始年月</label>
					</div>
					<div class="weui-cell__bd">
						<div class="monthpicker" name="month-date-from"></div>
					</div>
				</div>
				<div class="weui-cell select-month">
					<div class="weui-cell__hd">
						<label class="weui-label wy-lab">结束年月</label>
					</div>
					<div class="weui-cell__bd">
						<div class="monthpicker" name="month-date-to"></div>
					</div>
				</div>
