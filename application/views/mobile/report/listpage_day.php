...
<body ontouchstart>
	...
	<header class="wy-header">
		...
		<div class="wy-header-title">日报表增量<?if(isset($bills[0])):?>(<?=$bills[0]->date_from?> - <?=$bills[0]->date_to?>)<?endif?></div>
		<script>
	...
	<div class="weui-content">
	 <? $n = 0; ?>
			...
			<div class="weui-panel__hd">日期：<?=substr($v->create_time, 0, 19)?></div>
			<div class="weui-panel__bd">
				<div class="weui-media-box weui-media-box_text">
					...
					<ul class="weui-media-box__info">
						<li class="weui-media-box__info__meta">下级业绩：<em class="num"><?=cny($v->self_turnover)?></em></li>
						<li
