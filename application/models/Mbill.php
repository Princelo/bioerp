    ...
    public function objGetBillsOfDay($date_from = '', $date_to = '', $current_user_id = '', $limit = '')
    {
        ...
        $query_sql = "
            select
                ...
                coalesce(o_sub.volume::decimal+o_sub_0.volume::decimal, '$0') as      sub_turnover,
                ...
                coalesce(o_sub.gp_return_profit::decimal+o_sub_0.p_return_profit::decimal, '$0')                 normal_return_profit_sub2self,
